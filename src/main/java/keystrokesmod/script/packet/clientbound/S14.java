...
public class S14 extends SPacket {
   ...
   public S14(int entityId, byte posX, byte posY, byte posZ, byte yaw, byte pitch, boolean onGround) {
      super(new S17PacketEntityLookMove(entityId, posX, posY, posZ, yaw, pitch, onGround));
   ...
   public S14(int entityId, byte posX, byte posY, byte posZ, boolean onGround) {
      super(new S15PacketEntityRelMove(entityId, posX, posY, posZ, onGround));
      this.entityId = entityId;
      this.posX = posX;
      this.posY = posY;
      this.posZ = posZ;
   ...
   public S14(int entityId, byte yaw, byte pitch, boolean onGround) {
      super(new S16PacketEntityLook(entityId, yaw, pitch, onGround));
      this.entityId = entityId;
      this.yaw = yaw;
      this.pitch = pitch;
      this.onGround = onGround;
