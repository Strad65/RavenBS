...
public class S0B extends SPacket {
   ...
   private static Entity createEntityWithCustomID(int id) {
      EntityOtherPlayerMP entity = new EntityOtherPlayerMP(
         Minecraft.getMinecraft().theWorld, new GameProfile(UUID.fromString("ae7a42d0-31b1-4926-ba4c-f28d6efad4a9"), "")
      );
