...
public class C02 extends CPacket {
   ...
   public C02PacketUseEntity convert() {
      Action action = Utils.getEnum(Action.class, this.action);
      return this.hitVec != null && action == Action.INTERACT_AT
         ? new C02PacketUseEntity(this.entity.entity, new net.minecraft.util.Vec3(this.hitVec.x, this.hitVec.y, this.hitVec.z))
         : new C02PacketUseEntity(this.entity.entity, action);
   }
}
