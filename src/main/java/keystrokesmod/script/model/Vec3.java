...
public class Vec3 {
   ...
   public boolean equals(Vec3 vector2) {
      return this == vector2 ? true : this.x == vector2.x && this.y == vector2.y && this.z == vector2.z;
   }
   ...
   public static Vec3 convert(BlockPos blockPos) {
      return blockPos == null ? null : new Vec3(blockPos.getX(), blockPos.getY(), blockPos.getZ());
   }
