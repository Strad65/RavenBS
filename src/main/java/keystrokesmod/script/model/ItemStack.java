...
public class ItemStack {
   ...
   public ItemStack(net.minecraft.item.ItemStack itemStack, byte f1) {
      if (itemStack != null) {
         ...
         this.type = this.isBlock
            ? ((ItemBlock)itemStack.getItem()).getBlock().getClass().getSimpleName()
            : itemStack.getItem().getClass().getSimpleName();
         this.name = itemStack.getItem().getRegistryName().substring(10);
   ...
   private static net.minecraft.item.ItemStack withMeta(String name) {
      ...
      Item item = (Item)Item.itemRegistry.getObject(new ResourceLocation("minecraft:" + itemName));
   ...
   public static ItemStack convert(net.minecraft.item.ItemStack itemStack) {
      return itemStack == null ? null : new ItemStack(itemStack, (byte)0);
   }
